...
class GraphormerPYGDataset(Dataset):
    def __init__(
        ...
        if train_idx is None and train_set is None:
            ...
            #print(self.train_idx.shape,self.valid_idx.shape)
            self.train_data = self.index_select(self.train_idx)
    ...
    def index_select(self, idx):
        ...
        #print("Inside Index select.....")
        #print(torch.index_select(self.dataset,0,torch.tensor(idx)))
        #print(self.dataset[10,12])
